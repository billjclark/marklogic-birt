			...
			<TBODY>
				<TR>
					<TD class=content style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 10px; PADDING-TOP: 10px" >
						...
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=document.rptdesign&docURI=hen_viii.xml" %>">View Shakepeare's Henry VIII</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=document.rptdesign&docURI=j_caesar.xml" %>">View Shakepeare's Julius Caesar</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=document.rptdesign&docURI=macbeth.xml" %>">View Shakepeare's MacBeth</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=search.rptdesign&q=macbeth.xml" %>">View Shakepeare's MacBeth</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=bill.rptdesign&docURI=much_ado.zml" %>">View Shakepeare Much AdoExample</a>
						<p><a href="<%= request.getContextPath( ) + "/frameset?__report=bill.rptdesign&docURI=temptist.zml" %>">View Shakepeare Much AdoExample</a>
					</TD>
				</TR>
			</TBODY>
		</TABLE>
